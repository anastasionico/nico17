...
/** @lends <global> */(function (window, document, undefined) {
			...
			function _fnApplyColumnDefs(oSettings, aoColDefs, aoCols, fn) {
				...
				if (aoColDefs) {
					...
					for (i = aoColDefs.length - 1; i >= 0; i--) {
						...
						if (!$.isArray(aTargets)) {
							_fnLog(oSettings, 1, 'aTargets must be an array of targets, not a ' + (typeof aTargets === 'undefined' ? 'undefined' : _typeof(aTargets)));
						}
   ...
   */
     ...
     */
        ...
        */
					...
					if (iPushFeature == 1 && nTmp !== null) {
						if (_typeof(oSettings.aanFeatures[cOption]) !== 'object') {
    ...
    */
			function _fnFeatureHtmlLength(oSettings) {
				...
				if (aLengthMenu.length == 2 && _typeof(aLengthMenu[0]) === 'object' && _typeof(aLengthMenu[1]) === 'object') {
    ...
    */
			function _fnSaveState(oSettings) {
				...
				var i,
				    iLen,
				    bInfinite = oSettings.oScroll.bInfinite;
				var oState = {
			...
			function _fnExtend(oOut, oExtender) {
				...
				for (var prop in oExtender) {
					if (oExtender.hasOwnProperty(prop)) {
						...
						if (_typeof(oInit[prop]) === 'object' && val !== null && $.isArray(val) === false) {
    ...
    */
			var _fnJsonString = window.JSON ? JSON.stringify : function (o) {
				...
				var sType = typeof o === 'undefined' ? 'undefined' : _typeof(o);
				...
				for (sProp in o) {
					mValue = o[sProp];
					sType = typeof mValue === 'undefined' ? 'undefined' : _typeof(mValue);
    ...
    */
			this.fnAddData = function (mData, bRedraw) {
				...
				if (_typeof(mData[0]) === "object" && mData[0] !== null) {
    ...
    */
			this.fnDeleteRow = function (mTarget, fnCallBack, bRedraw) {
				...
				iAODataIndex = (typeof mTarget === 'undefined' ? 'undefined' : _typeof(mTarget)) === 'object' ? _fnNodeToDataIndex(oSettings, mTarget) : mTarget;
    ...
    */
			this.fnGetData = function (mRow, iCol) {
				...
				if (mRow !== undefined) {
					var iRow = mRow;
					if ((typeof mRow === 'undefined' ? 'undefined' : _typeof(mRow)) === 'object') {
    ...
    */
			this.fnUpdate = function (mData, mRow, iColumn, bRedraw, bAction) {
				var oSettings = _fnSettingsFromNode(this[DataTable.ext.iApiIndex]);
				var i, iLen, sDisplay;
				var iRow = (typeof mRow === 'undefined' ? 'undefined' : _typeof(mRow)) === 'object' ? _fnNodeToDataIndex(oSettings, mRow) : mRow;
   ...
   */
		DataTable.fnVersionCheck = function (sVersion) {
			...
			var fnZPad = function fnZPad(Zpad, count) {
   ...
   */
    ...
    *    } );
    */
			"fnFormatNumber": function fnFormatNumber(iIn) {
				if (iIn < 1000) {
    ...
    *    } );
    */
			"fnServerData": function fnServerData(sUrl, aoData, fnCallback, oSettings) {
				oSettings.jqXHR = $.ajax({
					"url": sUrl,
					"data": aoData,
   ...
   */
    ...
    */
			...
			"html-asc": function htmlAsc(x, y) {
				return x < y ? -1 : x > y ? 1 : 0;
			},

			"html-desc": function htmlDesc(x, y) {
				return x < y ? 1 : x > y ? -1 : 0;
			},
    ...
    */
			...
			"date-asc": function dateAsc(x, y) {
				return x - y;
			},

			"date-desc": function dateDesc(x, y) {
				return y - x;
			},
    ...
    * numerical sorting
    */
			"numeric-pre": function numericPre(a) {
				return a == "-" || a === "" ? 0 : a * 1;
			},

			"numeric-asc": function numericAsc(x, y) {
				return x - y;
			},

			"numeric-desc": function numericDesc(x, y) {
				return y - x;
			}
		});
