...
window.onload = function () {
	...
	this.onscroll = function () {
		...
		if (page == '') {
			...
			offsetTop_Hamburger_scrollBalls();
		} else if (page == 'freelance-web-developer-london' || page == 'web-developer-upwork' || page == 'web-designer-london' || page == 'web-design-london' || page == 'web-design-haringey' || page == 'web-design-camden' || page == 'creative-web-design-london') {
			offsetTop_Hamburger_scrollBalls();
			offsetTop_testimonial();
			offsetTop_AboutPhases();
