		...
		<div id="content">
		  	...
		  	<div id="content-header">
			    <div id="breadcrumb"> 
	    			...
	    			<a href="/admin/blog/supercategory" class="current">Blog Super Categories</a> 
	    			<a href="/admin/blog/supercategory/create" class="current">Create</a> 
    			</div>
			    <h1>Create a new Super Category</h1>
		  	</div>
